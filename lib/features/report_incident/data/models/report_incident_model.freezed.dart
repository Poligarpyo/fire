...
class _ReportIncidentModel extends ReportIncidentModel {
  const _ReportIncidentModel({required this.latitude, required this.longitude, required this.incidentType, required this.severityLevel, required this.additionalDetails}): super._();
