...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FireTruckState);
}
...
/// @nodoc
class $FireTruckStateCopyWith<$Res>  {
$FireTruckStateCopyWith(FireTruckState _, $Res Function(FireTruckState) __);
}
...
class _Initial implements FireTruckState {
  const _Initial();
...
class _Loading implements FireTruckState {
  const _Loading();
...
class _Success implements FireTruckState {
  const _Success();
...
class _Error implements FireTruckState {
...
@override
String toString() {
  return 'FireTruckState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $FireTruckStateCopyWith<$Res> {
